...
df_rm = spark.read.table("clubos_silver.silver_internal_asset_metrics") \
...
# Write to Gold
gold_df.write.format("delta").mode("overwrite").saveAsTable("clubos_gold.gold_peer_benchmark")

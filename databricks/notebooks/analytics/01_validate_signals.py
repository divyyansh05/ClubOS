...
df = spark.read.table("clubos_silver.silver_internal_asset_metrics")
...
# 5. Write to Gold
final_df.write.format("delta").mode("overwrite").saveAsTable("clubos_gold.gold_signal_relationships")
